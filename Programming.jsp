...
.contentblock:hover
{
    ...
    <div class="sidebar"> 
        ...
        <table style="margin-top:10px; width: 95%">
            ...
            <tr>
                <td class="tdtheme" style="padding-top:15px;background-color:lightgrey;"><font class="links">Programming</font></td>
    ...
    <div class="contents">
        <h1 style="color:#f4f4f4; padding-top: 10px; font-size: 25px; align-content: center; margin-left: 15px; font-family: Verdana; font-weight: normal;">Teachers for Programming:</h1>
        <br><br><br>
