  ...
  text-shadow: 2px 1px 2px black;
    ...
    <div class="topbar">
        ...
        <div class="topbar" style="margin-left:1150px; width: 50px;  align-content: center; margin-top: -30px; height: 20px;">
            <a href="StudentPage.jsp" class="links" style="color:#f4f4f4; font-size: 16px; padding-top: 30px; font-family: Verdana;">Home</a>
        </div>
    </div>
    ...
    <div class="sidebar"> 
        ...
        <table>
            ...
            <tr>
                <td class="tdtheme">
                    <a href="TeacherPage.jsp" class="links">
                    <img src="contact.png" width="22px" height="21px"> &nbsp;&nbsp;My Profile
                    </a>
                </td>
            </tr>
        </table>
    ...
    <div class="contents">
        <h1 style="color:#f4f4f4; padding-top: 10px; font-size: 25px; align-content: center; margin-left: 15px; font-family: Verdana; font-weight: normal;">Popular Teachers</h1>
    </div>    
    <br>
